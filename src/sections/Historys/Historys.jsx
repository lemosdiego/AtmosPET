      ...
      <div className="stories-box-container">
        <div className="stories-description">
          <p>
            ...
            abre o coração a um pet. Adotar não é apenas um ato de amor; também
            traz diversos benefícios para a saúde física e mental dos tutores.
            Estudos mostram que a presença de um animal de estimação pode
            reduzir o estresse, aumentar a sensação de bem-estar e até melhorar
            a saúde cardiovascular.
          </p>
          <br />
          <p>
            Leia alguns depoimentos de pessoas que encontraram amigos leais e
            alegres, tornando suas vidas mais completas e cheias de momentos
            especiais!
          </p>
        </div>
